...
dir = '/content/drive/MyDrive/Machine Learning/SVM Sample Dataset/INRIAPerson_Modified/Train'
categories = ['pos', 'neg']
...
for category in categories:
    ...
    for img in all_images:
        ...
        new_image = cv2.resize(color_image, (64, 128))
...
model.fit(HOG_values, labels)

pick = open('Linearsvm_model_v2.sav', 'wb')
